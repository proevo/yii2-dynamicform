...
class DynamicFormWidget extends \yii\base\Widget
{
    ...
    public function registerAssets($view)
    {
        ...
        // BUSCA O PARENT() E GERA UM ID PARA ATUAR SOMENTE NO BLOCO EM QUESTAO
        $js .= '    var boxItens = $(this).parent().parent();';
        $js .= '    boxItens.attr("id", "_'.$this->_hashVar.'_");';
        $js .= '    jQuery("#" + boxItens.attr("id") + " '.$this->widgetItem.':last select").each(function(){ this.selectedIndex=0; }).trigger("change");' . "\n";
        // ----------------------
